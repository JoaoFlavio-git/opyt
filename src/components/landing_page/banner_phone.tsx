...
const BannerPhoneComponent: React.FC = () => {
    return (<>
        <div className="flex sm:flex-row flex-col justify-center mt-5 banner-phone  w-full">
            <div className="flex sm:flex-row flex-col justify-evenly md:w-1/2">
                <div className="flex relative">
                    <div className="message-box-container ">
                        <Image src={"/images/banners/ballonImg.webp"} width={270} height={270} alt="Imagem do balão" layout="fixed" />
                    </div>
                    <div className="mobile-image-container justify-center p-5">
                        <Image src={"/images/banners/mobileHome.webp"} width={400} height={300} alt="Imagem do telefone" layout="fixed" />
                    </div>
                </div>
            </div>
            <div className="flex sm:flex-row flex-col text-black text-center  md:w-1/2">
                <h1 className="text-xl">Procurando <span className="font-bold text-2xl">o melhor plano de internet</span>, com maior velocidade e estabilidade de conexão?</h1>
            </div>
        </div>
